 ...
 */
public class BlobWanderGUI0 extends DrawingGUI {
	private static final int width=800, height=600;	// size of the world

	private BlobSA1 blob;								// the blob

	public BlobWanderGUI0() {
		super("Animated Blob", width, height);
	
		// Create blob at the center.
		blob = new BlobSA1(width/2, height/2);  // What happens if this isn't here? Try it so you see the symptom.
